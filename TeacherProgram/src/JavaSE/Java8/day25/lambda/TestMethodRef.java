...
public class TestMethodRef {
	...
	public void test5() {
		//使用匿名内部类
		Function<JavaSE.Java8.day25.bean.Employee,String>  fun1 = new Function<JavaSE.Java8.day25.bean.Employee,String>(){

			@Override
			public String apply(JavaSE.Java8.day25.bean.Employee t) {
				return t.getName();
			}
		...
		//使用方法引用
		Function<JavaSE.Java8.day25.bean.Employee,String>  fun2 = JavaSE.Java8.day25.bean.Employee::getName;
