package JavaSE.Java8.day25.lambda;
...
public class TestConstructorRef {
	...
	public void test3() {
		//使用匿名内部类
		A<String,Integer,Double,Character, JavaSE.Java8.day25.bean.Employee> a = new A<String,Integer,Double,Character, JavaSE.Java8.day25.bean.Employee>(){
			@Override
			public JavaSE.Java8.day25.bean.Employee method(String t, Integer r, Double m, Character u) {
				return new JavaSE.Java8.day25.bean.Employee(t,r,m,u);
			}
		};
		//使用构造器引用
//		A<String,Integer,Double,Character, JavaSE.Java8.day25.bean.Employee> b = Java8.bean.Employee::new;
	}
}
